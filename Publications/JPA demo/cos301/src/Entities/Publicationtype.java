...
@NamedQueries({
    ...
    @NamedQuery(name = "Publicationtype.findByName", query = "SELECT p FROM Publicationtype p WHERE p.name = :name")})
public class Publicationtype implements Serializable {
    ...
    public Publicationtype(Integer id) {
        this.id = id;
    }
    ...
    public String toString() {
        return "Entities.Publicationtype[ id=" + id + " ]";
    }
